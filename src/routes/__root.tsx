...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Crown Palm Oil LTD — Premium Red Palm Oil Manufacturer" },
      { name: "description", content: "Crown Palm Oil LTD produces premium, naturally-pressed red palm oil. Trusted food manufacturer rated 5.0 on Google." },
      { property: "og:title", content: "Crown Palm Oil LTD — Premium Red Palm Oil Manufacturer" },
      { property: "og:description", content: "Crown Palm Oil LTD produces premium, naturally-pressed red palm oil. Trusted food manufacturer rated 5.0 on Google." },
